    ...
    <div className="h-[60vh] w-full dark:bg-black bg-white dark:bg-grid-white/[0.1] bg-grid-black/[0.1] relative flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
          ...
          Watch algorithms come to life and gain a deep understanding of their
          behavior.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link href="/dsa">
            <button className="group px-8 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-full font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25 flex items-center gap-2">
              Start Learning
              <ArrowRightIcon className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
          </Link>
          <LinkPreview url="https://app.flexcode.in">
            <button className="group px-8 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-full font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25 flex items-center gap-2">
              Try FlexCode
              <ArrowRightIcon className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
